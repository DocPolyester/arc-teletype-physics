...
X IIQ 10       ; position of Ring 1
Y IIQ 11       ; velocity of Ring 1

; If angle > 4000: switch back to Spring
Z IIQ 12
IF GT Z 4000: IIS 4
```
...
- Pressing Encoder 0 + Encoder 1 simultaneously (within 2 s) also shuts down the Pi — without Teletype.
